...
int main(void)
{
	...
	show_arithmetic_mean_of_byte_margins(line_elements_nr, nr_lines,
										 pixel_matrix);
	...
	// Task 3
	// Find the biggest black hole
	printf("task 3\n");
	display_biggest_black_hole(pixel_matrix, line_elements_nr, nr_lines);
